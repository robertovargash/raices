        ...
        <div class="col-sm-6">
          <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-primary" href="{{ route('proveedors.index') }}"> Atrás</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-12">
          <div class="card card-default">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-12">
                  <form role="form" id="proveedorData" action="{{ route('proveedors.update',$proveedor->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="col-12">
                      <div class="form-group">
                          <strong>Nombre (*):</strong>
                          <input type="text" name="nombre" value="{{ $proveedor->nombre }}" id="idNombreProveedor" class="form-control" placeholder="Nombre">
                      </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            <strong>Siglas:</strong>
                            <input type="text" value="{{ $proveedor->siglas }}" name="siglas" class="form-control" placeholder="Siglas">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            <strong>REEUP:</strong>
                            <input type="text" value="{{ $proveedor->reeup }}" name="reeup" class="form-control" placeholder="REEUP">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            <strong>NIT:</strong>
                            <input type="text" value="{{ $proveedor->nit }}" name="nit" class="form-control" placeholder="NIT">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            <strong>Teléfono:</strong>
                            <input type="text" value="{{ $proveedor->telefono }}" name="telefono" class="form-control" placeholder="Teléfono">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            <strong>Dirección:</strong>
                            <textarea class="form-control" style="height:150px" name="direccion" placeholder="Dirección">{{ $proveedor->direccion }}</textarea>
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-footer justify-content-between">
          ...
          <form action="{{route('proveedorcuentas.destroy')}}" method="POST">
            @csrf
            @method('DELETE')
...
<div class="modal fade" id="modalAddCuenta">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            <form action="{{ route('proveedorcuentas.store') }}" id="addCuentaData" method="POST">
                @csrf
                 <div class="row">
                    <input type="hidden" name="proveedor_id" value="{{ $proveedor->id }}" class="form-control"/>
                    <div class="col-12">
                        <div class="form-group">
                            <strong>Banco*:</strong>
...
<div class="modal fade" id="modaleditCuenta">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            <form action="{{ route('proveedorcuentas.editar') }}" id="editCuentaDataForm" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
  ...
  $(document).ready(function () {
    ...
    $('#proveedorData').validate({
      ...
      messages: {
        ...
        direccion:{
            required: "Inserte la dirección del proveedor"
        },
      },
      errorElement: 'span',
